...
name: dict
kind: leaf
description: "Use when user asks to save, add, look up, list, or extract vocabulary (words, verbs, phrases, idioms) in their personal dictionary, OR asks to rewrite/flag/fix their own conversation sentences as a native engineer would phrase them, OR asks to update learning progress / graduate an entry / preview the dict files in a browser / start or stop the local progress server, OR asks to polish/rewrite/tighten a draft prompt for an AI agent, OR asks for a workplace conversation scenario (small talk, debate, meeting, presentation, technical). Trigger phrases: \"vocab\", \"dict\", \"my dictionary\", \"save word\", \"add word\", \"look up\", \"define\", \"extract verbs\", \"tech verbs\", \"review my sentences\", \"rewrite my sentences\", \"flag rough sentences\", \"fix sentences in this thread\", \"scan the conversation for awkward sentences\", \"preview\", \"open dict in browser\", \"browse dict\", \"start dict server\", \"stop dict server\", \"kill dict server\", \"I used X today\", \"bump X\", \"graduate X\", \"review my progress\", \"show progress\", \"polish prompt\", \"rewrite prompt\", \"tighten prompt\", \"small talk\", \"debate\", \"meeting scenario\", \"demo scenario\"."
---
